...
const HeadAndMetadata = () => (
  <Head>
    ...
    <meta
      name="description"
      content="Bridge USDC natively between blockchains for free. Send or transfer USDC between Ethereum, Avalanche and Arbitrum powered by Circle’s Cross-Chain Transfer Protocol."
    />
    ...
    <meta property="og:description" content="Bridge or transfer native USDC between Ethereum, Avalanche and Arbitrum powered by Circle's CCTP." />
    ...
    <meta name="twitter:description" content="Bridge or transfer native USDC between Ethereum, Avalanche and Arbitrum powered by Circle's CCTP." />
